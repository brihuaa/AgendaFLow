...
### 0-1 min: Contexto (El Problema)
> "¿Cuántos de ustedes dirigen un negocio de servicios? Peluquerías, spas, centros de belleza...  
> Seguro que reconocen el caos: clientes llamando constantemente para preguntar disponibilidad, empleados sin agenda clara, y el propietario sin ver ni un número sobre cómo va el negocio."

### 1-2 min: La Solución
> "AgendaFlow resuelve esto. Es una plataforma web que centraliza TODO: citas, empleados, servicios, horarios y analíticas.  
> Completamente lista para usar en menos de 60 segundos. Sin configuración compleja."

### 2-4 min: Demo en Vivo
1. **Login como Cliente** → "Mira, cualquier persona puede reservar una cita en 2 minutos"
   - Ir a ReservarCita
   - Elegir servicio, empleado, fecha, hora
   - Confirmar (mostrar en historial)

2. **Login como Empleado** → "El empleado ve su agenda del día sin confusiones"
   - Mostrar PanelEmpleado
   - Citas asignadas con filtro

3. **Login como Admin** → "Y aquí está el poder: visión completa del negocio"
   - Mostrar tabla de Reservas con KPIs (ingresos, citas completadas)
   - Filtros y búsqueda
   - Tab de Analytics: métricas por empleado, gráficas de ingresos

### 4-5 min: Características Técnicas
- [✓] Seguridad: JWT, bcrypt, rate-limiting
- [✓] Base de datos: 90 citas de ejemplo realistas
- [✓] Módulos desactivables (Analytics, Reseñas)
- [✓] Mobile-responsive
- [✓] Stack moderno: React 18 + Node.js + SQLite

### 5-6 min: ROI & Cierre
> "En números:
> - **-40%** llamadas telefónicas
> - **+20%** completitud de citas (menos cancelaciones)
> - **+visibilidad** — datos reales para decidir mejor
> - **0** curva de aprendizaje — intuitivo en 5 minutos
>
> AgendaFlow es el sistema que deberías tener desde el día 1 de tu negocio.
> Empezamos ahora, ¿preguntas?"
